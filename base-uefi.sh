...
echo "Asta" >> /etc/hostname
echo "127.0.0.1 localhost" >> /etc/hosts
echo "::1       localhost" >> /etc/hosts
echo "127.0.1.1 Asta.localdomain Asta" >> /etc/hosts
echo root:y1a2s3s4e5r6 | chpasswd
...
useradd -m yasser
echo yasser:yasser | chpasswd
usermod -aG libvirt yasser

echo "yasser ALL=(ALL) ALL" >> /etc/sudoers.d/yasser
